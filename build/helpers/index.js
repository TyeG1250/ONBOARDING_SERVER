...
export const successResponse = (req, res, data, code = 200, meta) => res.send({
  code,
  data,
  success: true,
  ...(meta !== undefined && {
...
export const errorResponse = (req, res, errorMessage = 'Something went wrong', code = 500, errors = []) => res.status(code).json({
  code,
  errorMessage,
  errors,
  data: null,
